                ...
                <div class="flex flex-col grow kt-scrollable-y-auto [--kt-scrollbar-width:auto] pt-5"
                    ...
                    <main class="grow" role="content">
                        ...
                        <div class="kt-container-fixed">
                            ...
                            {{-- TABLE YAYASAN --}}
                            <div class="mb-10">
                                <h2 class="text-lg font-semibold mb-3">Data Yayasan</h2>
                            ...
                            <div style="margin-top: 24px;">  
                                <h2 class="text-lg font-semibold mb-3">Data Sekolah</h2>
                                    ...
                                    <table class="table-auto w-full border border-gray-300">
                                        <thead class="bg-gray-100">
                                            <tr>
                                                ...
                                                <th class="border px-4 py-2">Yayasan</th>
                                                <th class="border px-4 py-2">No Tlp Sekolah</th>
                                            </tr>
                                        </thead>
                                        <tbody>
